    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 text-md-start text-center py-6">
                <h1 class="mb-4 fs-9 fw-bold">The laboratory Rule The World</h1>
                ...
                <div class="text-center text-md-start"><a class="btn btn-warning me-3 btn-lg" href="#!" role="button">Sign In</a></div>
            </div>
...
<section class="pt-5 pt-md-9 mb-6" id="feature">
    ...
    <div class="container">
        <h1 class="fs-9 fw-bold mb-4 text-center"> Type Laboratory <br></h1>
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <p class="mb-4 fw-medium text-secondary">
                    Sintara is an animation and multimedia laboratory that provides computers with high specifications
                    that are useful for editing and creating animations with international standards
                </p>
                <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2" src="member-assets/img/manager/tick.png" width="35" alt="tick" />
                    <h3 class="fw-medium mb-0 text-secondary">20-30 person</h3>
                </div>
                <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2" src="member-assets/img/manager/tick.png" width="35" alt="tick" />
...
<section class="pt-5" id="manager">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <h5 class="text-secondary">Laboratory 2</h5>
                <p class="fs-7 fw-bold mb-2">Sludge</p>
                <p class="mb-4 fw-medium text-secondary">
                    Sludge is a chemical laboratory that has many chemicals and chemical tools that are very supportive in the research process and practicum process,
                    this laboratory also has an international standard license.
                </p>
                <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2" src="member-assets/img/manager/tick.png" width="35" alt="tick" />
                    <h3 class="fw-medium mb-0 text-secondary">20-30 person</h3>
                </div>
...
<section class="pt-5" id="marketer">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h5 class="text-secondary">Laboratory 3</h5>
                <p class="mb-2 fs-8 fw-bold">Astra</p>
                <p class="mb-4 fw-medium text-secondary">Astra is a computer laboratory that has high specifications and supports various devices that can spoil your tasks and eyes while working and doing practicals</p>
                <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2" src="member-assets/img/manager/tick.png" width="35" alt="tick" />
                    <h3 class="fw-medium mb-0 text-secondary">20-30 person</h3>
                </div>
                <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2" src="member-assets/img/manager/tick.png" width="35" alt="tick" />
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
                <h1 class="fw-bold mb-4 fs-7">Need some laboratory?</h1>
                <p class="mb-5 text-info fw-medium">Do you require some help for your project: Conception workshop,<br />prototyping, animation, chemical?</p>
                <button class="btn btn-warning btn-md">Book Our Laboratory</button>
            </div>
        </div>
    </div>
    <!-- end of .container-->
...
<section class="pt-5" id="marketing">
    ...
    <div class="container">
        ...
        <p class="mb-6 text-secondary">Join 40,000+ other people and get many benefit from this laboratory</p>
        <div class="row">
