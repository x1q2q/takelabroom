<section class="pb-2 pb-lg-5">
    ...
    <div class="container">
        <div class="row border-top border-top-secondary pt-7">
            <div class="col-lg-3 col-md-6 mb-4 mb-md-6 mb-lg-0 mb-sm-2 order-1 order-md-1 order-lg-1"><img class="mb-4" src="https://tumpi.id/wp-content/uploads/2018/01/download-logo-uns-besar-biru-png.png" width="184" alt="" /></div>
        ...
        <div class="container border-top py-3">
            <div class="row justify-content-between">
                <div class="col-12 col-md-auto mb-1 mb-md-0">
                    <p class="mb-0">&copy; 2022 ADA Company Inc </p>
                </div>
