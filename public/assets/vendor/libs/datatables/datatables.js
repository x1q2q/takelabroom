 ...
 *   https://datatables.net/download/#bs4/dt-1.11.5/r-2.2.9/rr-1.2.8/sp-2.0.0
 *
 * Included libraries:
 *   DataTables 1.11.5, Responsive 2.2.9, RowReorder 1.2.8, SearchPanes 2.0.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.models.oSearch = {
		...
		DataTable.ext = _ext = {
			 ...
			 *  @type string
			 */
			build:"bs4/dt-1.11.5/r-2.2.9/rr-1.2.8/sp-2.0.0",
